...
#predefinida. A palavra secreta será representada por espaços em branco, um para cada letra da palavra.
...
#Se a letra não estiver na palavra, uma mensagem de erro deverá ser informada. Após um número máximo
#de erros, o jogador perde. O jogo continua até que o jogador adivinhe a palavra ou exceda o número máximo
#de tentativas.
